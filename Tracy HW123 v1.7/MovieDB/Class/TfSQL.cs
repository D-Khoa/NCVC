...
namespace Tracy
{
    public class TfSQL
    {
        ...
        static string conStringTraceSheetDb = @"Server=192.168.193.4;Port=5432;User Id=pqm;Password=dbuser;Database=tracydb; CommandTimeout=100; Timeout=100;";
        static string conStringPqmDb = @"Server=192.168.193.2;Port=5432;User Id=pqm;Password=dbuser;Database=pqmdb; CommandTimeout=100; Timeout=100;";
