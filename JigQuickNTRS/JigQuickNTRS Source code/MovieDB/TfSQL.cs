...
namespace JigQuick
{
    class TfSQL
    {
        ...
        string conStringPqmDb = @"Server=192.168.193.4;Port=5432;User Id=pqm;Password=dbuser;Database=pqmdb; CommandTimeout=100; Timeout=100;";
        string conStringTesterDb = @"Server=192.168.193.4;Port=5432;User Id=pqm;Password=dbuser;Database=pqmdb; CommandTimeout=100; Timeout=100;";
        static string conStringTraceSheetDb = @"Server=192.168.193.4;Port=5432;User Id=pqm;Password=dbuser;Database=ncardb; CommandTimeout=100; Timeout=100;";
