...
namespace BoxIdDb
{
    public class TfPrintSmall
    {
            ...
            DataGridView dgv1, ref DataGridView dgv2, ref TextBox txt, string shipKind)
        {
            ...
            Bitmap bmp1 = new Bitmap(480, txt.Height + dgv2.Height * 5/*10 + txt.Height * 2 + dgv2.Height * 2*/);
            ...
            for (int i = 0; i < 5; i++)
            {
                Rectangle destRect = new Rectangle(0, 10 + txt.Height * 2 + dgv2.Height * i, 80 * 6, dgv2.Height);
                Rectangle srcRect = new Rectangle(80 * 6 * i, 0, 80 * 6, dgv2.Height);
