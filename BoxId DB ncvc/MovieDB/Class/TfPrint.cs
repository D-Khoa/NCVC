...
namespace BoxIdDb
{
    ...
    {
        public string mol;
        public void createBoxidFiles(string dir, string id, string model, string shaft, string overlay,
            DataGridView dgv1, ref DataGridView dgv2, ref TextBox txt, string shipKind)
        {
            ...
            Bitmap bmp1 = new Bitmap(550, 10 + txt.Height * 2 + dgv2.Height * 2);
            ...
            string s = (shaft.ToLower() == "null" || shaft == String.Empty) ? String.Empty : "Shaft:" + shaft + " ";
            string o = (overlay.ToLower() == "null" || overlay == String.Empty) ? String.Empty : "Overlay:" + overlay + "  ";
            txt.Text = s + o + shipKind + ", Rev A";
            ...
            for (int i = 0; i < 2; i++)
            {
                Rectangle destRect = new Rectangle(50, 10 + txt.Height * 2 + dgv2.Height * i, 150 * 3, dgv2.Height);
                Rectangle srcRect = new Rectangle(150 * 3 * i, 0, 150 * 3, dgv2.Height);
