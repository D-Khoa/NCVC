...
namespace BoxIdDb
{
    public class TfSQL
    {
        ...
        public bool sqlMultipleInsert523(DataTable dt)
        {
            int res1;
            bool res2 = false;
            connection = new NpgsqlConnection(conStringBoxidDb);
            ...
            try
            {
                string sql = "INSERT INTO product_serial_523(boxid, serialno, model, carton, lot, cir_ccw, cg_ccw, cnr_ccw, aio_ccw, ano_ccw, air_ccw, anr_ccw, ais_ccw, judge, return) VALUES (:boxid, :serialno, :model, :carton, :lot, :cir_ccw, :cg_ccw, :cnr_ccw, :aio_ccw, :ano_ccw, :air_ccw, :anr_ccw, :ais_ccw, :judge, :return)";
                NpgsqlCommand command = new NpgsqlCommand(sql, connection);
