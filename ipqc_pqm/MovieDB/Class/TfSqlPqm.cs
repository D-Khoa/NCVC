...
namespace IpqcDB
{
    public class TfSqlPqm
    {
        ...
        // Batch registration in PQM table
            ...
            DateTime lot, DateTime inspectdate, string line, DataTable dt, double upper, double lower)
        {
            ...
            try
            {
                ...
                // Delete data that already exists in the DB table and register.
                // However, when an exception occurs, both deletion and registration are rolled back.
                // Delete①：
                ...
                {
                    // Register only for the balance, only the difference between the two values
            ...
            DateTime lot, DateTime inspectdate, string line)
        {
            ...
            try
            {
                ...
                // Delete data that already exists in the DB table and register. However, when an exception occurs, both deletion and registration are rolled back.
                // Delete ①：
                string sql1 = "delete from " + pqmTable1 + " where " +
                    "model ='" + model + "' and " +
                    "process ='" + process + "' and " +
        ...
        // Subprocedure: Identify the name of the PQM table to be referenced
        ...
        // Subprocedure: Identify the PQM table name as the connection string to be referred to
