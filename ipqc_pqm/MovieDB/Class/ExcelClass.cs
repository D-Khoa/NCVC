...
namespace IpqcDB
{
    public class ExcelClass
    {
        ...
        // Export data table to Excel(XR chart / with histogram)    
        ...
        // Export data table to Excel (With box beard drawing)    
