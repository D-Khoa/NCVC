...
{
    public partial class EfficiencyListFormB : Form
    {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            EfficiencyUpdateB effU = new EfficiencyUpdateB();
            effU.ShowDialog();
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            EfficiencyViewB effV = new EfficiencyViewB();
            effV.ShowDialog();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (re == DialogResult.Yes)
            {
                if (!String.IsNullOrEmpty(cmbModel.Text) && !String.IsNullOrEmpty(cmbSubAssy.Text) && !String.IsNullOrEmpty(cmbLine.Text) && !String.IsNullOrEmpty(cmbShift.Text))
                {
                    ...
                    EfficiencyReportB effR = new EfficiencyReportB();
                    effR.ShowDialog();
