...
{
    public partial class EfficiencyViewB : Form
    {
        ...
        private void initFormEfficiencyView()
        {
            ...
            lblCheck.Text = "Checked by: " + EfficiencyListFormB.Check;
            lblApprove.Text = "Approved by: " + EfficiencyListFormB.Approve;
            if (!String.IsNullOrEmpty(EfficiencyListFormB.Check))
            {
        ...
        {
            if (frmLogin.permission == "1" && String.IsNullOrEmpty(EfficiencyListFormB.Check))
            {
                btnCheck.Enabled = true;
                btnApprove.Enabled = false;
            }
            else if (frmLogin.flagAdminUser == true && !String.IsNullOrEmpty(EfficiencyListFormB.Check))
            {
                btnApprove.Enabled = true;
            }

            if (!String.IsNullOrEmpty(EfficiencyListFormB.Approve))
            {
                btnApprove.Enabled = false;
            }
        }
