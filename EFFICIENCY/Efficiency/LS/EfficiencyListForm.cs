...
{
    public partial class EfficiencyListForm : Form
    {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            EfficiencyUpdate effU = new EfficiencyUpdate();
            effU.ShowDialog();
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            EfficiencyView effV = new EfficiencyView();
            effV.ShowDialog();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (re == DialogResult.Yes)
            {
                if (!String.IsNullOrEmpty(cmbModel.Text) && !String.IsNullOrEmpty(cmbSubAssy.Text) && !String.IsNullOrEmpty(cmbLine.Text) && !String.IsNullOrEmpty(cmbShift.Text))
                {
                    ...
                    EfficiencyReport effR = new EfficiencyReport();
                    effR.ShowDialog();
