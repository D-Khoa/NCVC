...
{
    public partial class EfficiencyViewPRO1 : Form
    {
        ...
        {
            txtLine.Text = EfficiencyListFormPRO1.m_line;
            txtModel.Text = EfficiencyListFormPRO1.m_model;
            txtSubAssy.Text = EfficiencyListFormPRO1.m_subAssy;
            txtEfficiencyNo.Text = EfficiencyListFormPRO1.effNo;
            lblDate.Text = EfficiencyListFormPRO1.createDate;
            txtShift.Text = EfficiencyListFormPRO1.Shift;
            txtLeader.Text = EfficiencyListFormPRO1.User;
            ...
            lblCheck.Text = "Checked by: " + EfficiencyListFormPRO1.Check;
            lblApprove.Text = "Approved by: " + EfficiencyListFormPRO1.Approve;
            if (!String.IsNullOrEmpty(EfficiencyListFormPRO1.Check))
            {
        ...
        {
            if (frmLogin.permission == "1" && String.IsNullOrEmpty(EfficiencyListFormPRO1.Check))
            {
                btnCheck.Enabled = true;
                btnApprove.Enabled = false;
            }
            else if (frmLogin.flagAdminUser == true && !String.IsNullOrEmpty(EfficiencyListFormPRO1.Check))
            {
                btnApprove.Enabled = true;
            }

            if (!String.IsNullOrEmpty(EfficiencyListFormPRO1.Approve))
            {
                btnApprove.Enabled = false;
            }
        }
